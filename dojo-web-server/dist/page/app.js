      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.body)(CSSUtils.pair("font-family")("Consolas, monospace")))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.charblock)(CSS_Display.display(CSS_Display.inlineBlock)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.charblock)(CSSUtils.byClass(ClassNames.keyCorrect)))(CSS_Background.backgroundColor(Colors.robinsEggBlue)))(function () {
                  return CSS_Stylesheet.select(CSS_Selector["with"](Selectors.charblock)(CSSUtils.byClass(ClassNames.keyWrong)))(CSS_Background.backgroundColor(Colors.monza));
              });
          });
      });
  });
...
(function(exports) {
  ...
  var isPrint = function (str) {
      ...
      throw new Error("Failed pattern match at ViewComponent line 45, column 1 - line 45, column 29: " + [ str.constructor.name ]);
  };
  ...
  var charBlock = function (v) {
      return Halogen_HTML_Elements.span([ HalogenUtils.classList_([ new Data_Tuple.Tuple(true, ClassNames.charblock), new Data_Tuple.Tuple(Data_Eq.eq(eqKeyMatch)(v.status)(KeyCorrect.value), ClassNames.keyCorrect), new Data_Tuple.Tuple(Data_Eq.eq(eqKeyMatch)(v.status)(KeyWrong.value), ClassNames.keyWrong) ]) ])([ Halogen_HTML_Core.text(ShowChar.showChar(v.key)) ]);
  };
  var render = function (v) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_(Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
          return function (item) {
              return Data_Array.snoc(acc)(charBlock(item));
          };
      })([  ])(processed)), Halogen_HTML_CSS.stylesheet(CSS_Root.root) ]);
  };
  var addOnKeyDownEventListener = function (document) {
      return function (fn) {
          var target = Web_HTML_HTMLDocument.toEventTarget(document);
          return function __do() {
              var v = Web_Event_EventTarget.eventListener(function ($53) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(fn)(Web_UIEvent_KeyboardEvent.fromEvent($53));
              })();
  ...
  var $$eval = function (v) {
      if (v instanceof Init) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addOnKeyDownEventListener(v1))(function ($54) {
                  return Data_Maybe.Just.create(Halogen_Query.request(OnKeyDown.create($54)));
              })))(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $42.history = Data_Array.snoc(v2.history)({
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isPrint(key))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isBackspace(key))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $48.input = Data_String_CodeUnits.dropRight(1)(v2.input);
                                  return $48;
                              })))(function () {
      ...
      throw new Error("Failed pattern match at ViewComponent line 139, column 1 - line 139, column 54: " + [ v.constructor.name ]);
  };
