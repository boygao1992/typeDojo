...
(function(exports) {
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var Prelude = PS["Prelude"];
  var safeFromHexString = function ($17) {
      return Data_Maybe.fromMaybe(Color.white)(Color.fromHexString($17));
  };
  var pair = function (k) {
      return function (v) {
          return CSS_Stylesheet.key(CSS_Property.valValue)(CSS_String.fromString(CSS_Property.isStringKey)(k))(CSS_Property.value(CSS_Property.valString)(v));
      };
  };
  ...
  var class_ = function (s) {
      return CSS_Selector["with"](CSS_Selector.star)(byClass(s));
  };
...
(function(exports) {
  // Generated by purs version 0.12.1
  "use strict";
  var keyWrong = "key-wrong";
  var keyCorrect = "key-correct";
  var cursor = "cursor";
  var charblock = "charblock";
  exports["charblock"] = charblock;
  exports["keyCorrect"] = keyCorrect;
  exports["keyWrong"] = keyWrong;
...
(function(exports) {
  ...
  var monza = CSSUtils.safeFromHexString("#C90014");
  var gray = CSSUtils.safeFromHexString("#828282");
...
(function(exports) {
  ...
  var charblock = CSSUtils.class_(ClassNames.charblock);
  exports["charblock"] = charblock;
...
(function(exports) {
  ...
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.star)(CSS_Box.boxSizing(CSS_Box.borderBox)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.body)(CSSUtils.pair("font-family")("Consolas, monospace")))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(Selectors.charblock)(CSS_Display.display(CSS_Display.inlineBlock)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.charblock)(CSSUtils.byClass(ClassNames.keyCorrect)))(CSS_Background.backgroundColor(Colors.robinsEggBlue)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](Selectors.charblock)(CSSUtils.byClass(ClassNames.keyWrong)))(CSS_Background.backgroundColor(Colors.monza)))(function () {
                      return CSS_Stylesheet.select(CSS_Selector["with"](Selectors.charblock)(CSSUtils.byClass(ClassNames.cursor)))(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(1.0))(Colors.gray));
                  });
              });
          });
      });
...
(function(exports) {
  ...
  var classList_ = function ($0) {
      return Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(function ($1) {
          return Halogen_HTML_Core.ClassName(Data_Tuple.snd($1));
      })(Data_Array.filter(Data_Tuple.fst)($0)));
  };
  exports["classList_"] = classList_;
})(PS["HalogenUtils"] = PS["HalogenUtils"] || {});
(function(exports) {exports.showChar = function ( c ) {
...
})(PS["ShowChar"] = PS["ShowChar"] || {});
(function(exports) {
  // Generated by purs version 0.12.1
  "use strict";
  var $foreign = PS["ShowChar"];
  exports["showChar"] = $foreign.showChar;
})(PS["ShowChar"] = PS["ShowChar"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var Halogen_Query_EventSource = PS["Halogen.Query.EventSource"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var HalogenUtils = PS["HalogenUtils"];
  var $$Math = PS["Math"];
  var Prelude = PS["Prelude"];
  var ShowChar = PS["ShowChar"];
  var Web_Event_Event = PS["Web.Event.Event"];
  var Web_Event_EventTarget = PS["Web.Event.EventTarget"];
  var Web_HTML = PS["Web.HTML"];
  var Web_HTML_HTMLDocument = PS["Web.HTML.HTMLDocument"];
  ...
  var StartToken = (function () {
      ...
      StartToken.value = new StartToken();
      return StartToken;
  })();
  var RegularToken = (function () {
      function RegularToken(value0) {
          this.value0 = value0;
      };
      RegularToken.create = function (value0) {
          return new RegularToken(value0);
      };
      return RegularToken;
  })();
  ...
  var OnKeyDown = (function () {
      function OnKeyDown(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OnKeyDown.create = function (value0) {
          return function (value1) {
              return new OnKeyDown(value0, value1);
          };
      };
      return OnKeyDown;
  })();
  ...
  //   , status :: KeyMatch
  //   }
  var KeyCorrect = (function () {
      function KeyCorrect() {

      };
      KeyCorrect.value = new KeyCorrect();
      return KeyCorrect;
  })();
  ...
  //   , status :: KeyMatch
  //   }
  var KeyWrong = (function () {
      function KeyWrong(value0) {
          this.value0 = value0;
      };
      KeyWrong.create = function (value0) {
          return new KeyWrong(value0);
      };
      return KeyWrong;
  })();
  ...
  //   , status :: KeyMatch
  //   }
  var KeyNoInput = (function () {
      function KeyNoInput() {

      };
      KeyNoInput.value = new KeyNoInput();
      return KeyNoInput;
  })();

  // TODO: use purescript-formatters
  var viewTimer = function (v) {
      var minutes = $$Math.floor(v / 60000.0);
      var seconds = $$Math.floor((v - minutes * 60000.0) / 1000.0);
      var milliseconds = v - (minutes * 60000.0 + seconds * 1000.0);
      return Data_Show.show(Data_Show.showInt)(Data_Int.floor(minutes)) + (" : " + (Data_String_CodeUnits.takeRight(2)((function (v1) {
          return "0" + v1;
      })(Data_Show.show(Data_Show.showInt)(Data_Int.floor(seconds)))) + (" : " + Data_String_CodeUnits.takeRight(3)((function (v1) {
          return "00" + v1;
      })(Data_Show.show(Data_Show.showInt)(Data_Int.floor(milliseconds)))))));
  };
  var showStatus = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at ViewComponent line 166, column 1 - line 166, column 35: " + [ v.constructor.name ]);
  });
  var repGenericSession = new Data_Generic_Rep.Generic(function (x) {
      return x;
  }, function (x) {
      return x;
  });
  var removeEscapeChar = (function () {
      var escapeFilter = function (v) {
          if (v.value1 instanceof RegularToken) {
              if (v.value0 === "\\" && v.value1.value0 === "\\") {
                  return true;
              };
              if (v.value0 === "\\") {
                  return false;
          ...
          if (v.value1 instanceof StartToken) {
              return true;
          };
          throw new Error("Failed pattern match at ViewComponent line 72, column 5 - line 72, column 48: " + [ v.constructor.name ]);
      };
      return function ($144) {
          return Data_String_CodeUnits.fromCharArray(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.fst)(Data_Array.filter(escapeFilter)(Data_Tuple.uncurry(Data_Array.zip)(Data_Profunctor_Strong.fanout(Control_Category.categoryFn)(Data_Profunctor_Strong.strongFn)(Control_Category.identity(Control_Category.categoryFn))(function ($145) {
              return Data_Array.cons(StartToken.value)(Data_Functor.map(Data_Functor.functorArray)(RegularToken.create)($145));
          })(Data_String_CodeUnits.toCharArray($144))))));
      };
  })();
  ...
  var isPrint = function (str) {
      ...
      if (Data_Boolean.otherwise) {
          return Data_String_CodePoints.length(str) === 1;
      };
      throw new Error("Failed pattern match at ViewComponent line 96, column 1 - line 96, column 29: " + [ str.constructor.name ]);
  };
  var isLeft = function (v) {
      return v === "ArrowLeft";
  };
  var isInsert = function (v) {
      return v === "Insert";
  };
  var isEnter = function (v) {
      return v === "Enter";
  };
  var isBackspace = function (v) {
      return v === "Backspace";
  };

  // | Utils
  var interval = function (initTime) {
      return function (currentTime) {
          return Data_Maybe.fromMaybe(Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds))(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Time.diff(Data_Time_Duration.durationMilliseconds))(currentTime))(initTime));
      };
  };
  var initialState = {
      history: [  ],
      ...
      initTime: Data_Maybe.Nothing.value,
      currentTime: Data_Maybe.Nothing.value,
      duration: Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds)
  };
  ...
  // | View
  var charBlock = function (isCursor) {
      return function (v) {
          return Halogen_HTML_Elements.span([ HalogenUtils.classList_(Data_Array.snoc([ new Data_Tuple.Tuple(true, ClassNames.charblock), new Data_Tuple.Tuple(isCursor, ClassNames.cursor) ])((function () {
              if (v.status instanceof KeyCorrect) {
                  return new Data_Tuple.Tuple(true, ClassNames.keyCorrect);
              };
              if (v.status instanceof KeyWrong) {
                  return new Data_Tuple.Tuple(true, ClassNames.keyWrong);
              };
              if (v.status instanceof KeyNoInput) {
                  return new Data_Tuple.Tuple(false, "");
              };
              throw new Error("Failed pattern match at ViewComponent line 229, column 17 - line 233, column 15: " + [ v.status.constructor.name ]);
          })())) ])([ Halogen_HTML_Core.text(ShowChar.showChar(v.key)) ]);
      };
  };

  // | Component
  var render = function (v) {
      var _input = Data_String_CodeUnits.toCharArray(v.input);
      var _dojo = Data_String_CodeUnits.toCharArray(v.dojo);
      var processed = (function (v1) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1)(Data_Functor.map(Data_Functor.functorArray)(function (d) {
              return {
                  key: d,
                  status: KeyNoInput.value
              };
          })(Data_Array.takeEnd(Data_String_CodePoints.length(v.dojo) - Data_String_CodePoints.length(v.input) | 0)(_dojo)));
      })(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
          var $76 = v1.value0 === v1.value1;
          if ($76) {
              return {
                  key: v1.value1,
                  status: KeyCorrect.value
              };
          };
          return {
              key: v1.value1,
              status: new KeyWrong(v1.value0)
          };
      })(Data_Array.zip(_input)(_dojo)));
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(viewTimer(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v.duration)(interval(v.initTime)(v.currentTime)))) ]), Halogen_HTML_Elements.p_(Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (idx) {
          return function (acc) {
              return function (item) {
                  return Data_Array.snoc(acc)(charBlock(v.cursor === idx)(item));
              };
          };
      })([  ])(processed)), Halogen_HTML_Elements.p([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.displayNone))(function () {
          return Control_Applicative.when(CSS_Stylesheet.applicativeStyleM)(Data_String_CodePoints.length(v.input) === Data_String_CodePoints.length(v.dojo))(CSS_Display.display(CSS_Display.block));
      })) ])([ Halogen_HTML_Core.text("Enter to submit") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("cursor: " + Data_Show.show(Data_Show.showInt)(v.cursor)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("status: " + Data_Show.show(showStatus)(v.status)) ]), Halogen_HTML_CSS.stylesheet(CSS_Root.root) ]);
  };
  var addTimer = function (window) {
      return function (fn) {
          return function __do() {
              var v = Effect_Timer.setInterval(50)(Data_Functor["void"](Effect.functorEffect)(Web_HTML_Window.requestAnimationFrame(Control_Bind.bindFlipped(Effect.bindEffect)(fn)(Effect_Now.nowTime))(window)))();
  ...
  // | Effect
  var addOnKeyDownEventListener = function (document) {
      return function (fn) {
          var target = Web_HTML_HTMLDocument.toEventTarget(document);
          return function __do() {
              var v = Web_Event_EventTarget.eventListener(function ($146) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(fn)(Web_UIEvent_KeyboardEvent.fromEvent($146));
              })();
              Web_Event_EventTarget.addEventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(v)(false)(target)();
              return Web_Event_EventTarget.removeEventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(v)(false)(target);
          };
      };
  };
  var $$eval = function (v) {
      if (v instanceof Init) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_Window.document(v1)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addOnKeyDownEventListener(v2))(function ($147) {
                      return Data_Maybe.Just.create(Halogen_Query.request(OnKeyDown.create($147)));
                  })))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.get(Affjax_ResponseFormat.string)("/dojo")))(function (v3) {
                          var dojo = removeEscapeChar(Data_String_CodeUnits.dropRight(1)(Data_String_CodeUnits.drop(1)(Data_Either.either(Data_Function["const"](""))(Control_Category.identity(Control_Category.categoryFn))(v3.body))));
      ...
      if (v instanceof OnKeyDown) {
          var startTimer = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v1) {
              return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addTimer(v1))(function ($148) {
                  return Data_Maybe.Just.create(Halogen_Query.request(Tick.create($148)));
              }));
          });
          var key = Web_UIEvent_KeyboardEvent.key(v.value0);
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(!isInsert(key))(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0)))))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.nowTime))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $100.history = Data_Array.snoc(v2.history)({
                              key: Web_UIEvent_KeyboardEvent.key(v.value0),
                              timeStamp: v1,
                              status: v2.status
                          });
                          return $100;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isEnter(key) && (Data_Eq.eq(eqStatus)(v2.status)(Playing.value) && Data_String_CodePoints.length(v2.input) === Data_String_CodePoints.length(v2.dojo)))((function () {
                              var duration = Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v2.duration)(interval(v2.initTime)(new Data_Maybe.Just(v1)));
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $103 = {};
                                  for (var $104 in v3) {
                                  ...
                                  $103.status = Stopped.value;
                                  $103.initTime = new Data_Maybe.Just(v1);
                                  $103.currentTime = new Data_Maybe.Just(v1);
                                  $103.duration = duration;
                                  return $103;
                              }))(function () {
                                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.put(Affjax_ResponseFormat.string)("/dojo/record")(Affjax_RequestBody.string(Foreign_Generic.genericEncodeJSON(repGenericSession)(Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
                                      return "Session";
                                      ...
                                      input: v2.input,
                                      dojo: v2.dojo,
                                      duration: Data_Newtype.unwrap(Data_Time_Duration.newtypeMilliseconds)(duration)
                                  })))));
                              });
                          })()))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isPrint(key))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_String_CodePoints.length(v2.input) < Data_String_CodePoints.length(v2.dojo))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $106 = {};
                                  for (var $107 in v3) {
                                  ...
                                  $106.input = v2.input + key;
                                  return $106;
                              })))(function () {
                                  if (v2.status instanceof Stopped) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          var $110 = {};
                                          for (var $111 in v3) {
                                          ...
                                          $110.status = Playing.value;
                                          $110.initTime = new Data_Maybe.Just(v1);
                                          $110.currentTime = new Data_Maybe.Just(v1);
                                          $110.duration = Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds);
                                          return $110;
                                      }))(function () {
                                          return startTimer;
                                      });
                                  };
                                  if (v2.status instanceof Paused) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          var $113 = {};
                                          for (var $114 in v3) {
                                          ...
                                          $113.status = Playing.value;
                                          $113.initTime = new Data_Maybe.Just(v1);
                                          $113.currentTime = new Data_Maybe.Just(v1);
                                          return $113;
                                      }))(function () {
                                          return startTimer;
                                      });
                                  };
                                  if (v2.status instanceof Playing) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                  };
                                  throw new Error("Failed pattern match at ViewComponent line 346, column 5 - line 364, column 27: " + [ v2.status.constructor.name ]);
                              })))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isBackspace(key))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      var $116 = {};
                                      for (var $117 in v3) {
                                      ...
                                      $116.input = Data_String_CodeUnits.dropRight(1)(v2.input);
                                      return $116;
                                  })))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isLeft(key) && v2.cursor > 0)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          var $119 = {};
                                          for (var $120 in v3) {
                                          ...
                                          $119.cursor = v2.cursor - 1 | 0;
                                          return $119;
                                      })))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isRight(key) && v2.cursor < (Data_String_CodePoints.length(v2.dojo) - 1 | 0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                              var $122 = {};
                                              for (var $123 in v3) {
                                              ...
                                              $122.cursor = v2.cursor + 1 | 0;
                                              return $122;
                                          })))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isSpace(key))((function () {
                                                  if (v2.status instanceof Stopped) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                          var $126 = {};
                                                          for (var $127 in v3) {
                                                          ...
                                                          $126.status = Playing.value;
                                                          $126.initTime = new Data_Maybe.Just(v1);
                                                          $126.currentTime = new Data_Maybe.Just(v1);
                                                          $126.duration = Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds);
                                                          return $126;
                                                      }))(function () {
                                                          return startTimer;
                                                      });
                                                  ...
                                                  if (v2.status instanceof Paused) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                          ...
                                                          $129.status = Playing.value;
                                                          $129.initTime = new Data_Maybe.Just(v1);
                                                          $129.currentTime = new Data_Maybe.Just(v1);
                                                          return $129;
                                                      }))(function () {
                                                          return startTimer;
                                                      });
                                                  ...
                                                  if (v2.status instanceof Playing) {
                                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                          ...
                                                          $132.status = Paused.value;
                                                          $132.initTime = new Data_Maybe.Just(v1);
                                                          $132.currentTime = new Data_Maybe.Just(v1);
                                                          $132.duration = Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v2.duration)(interval(v2.initTime)(new Data_Maybe.Just(v1)));
                                                          return $132;
                                                      });
                                                  };
                                                  throw new Error("Failed pattern match at ViewComponent line 376, column 5 - line 401, column 15: " + [ v2.status.constructor.name ]);
                                              })()))(function () {
      ...
      if (v instanceof Tick) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              if (v1 instanceof Stopped) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Halogen_Query_EventSource.Done.value));
              };
              if (v1 instanceof Paused) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Halogen_Query_EventSource.Done.value));
              };
              if (v1 instanceof Playing) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $139.currentTime = new Data_Maybe.Just(v.value0);
                      return $139;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Halogen_Query_EventSource.Listening.value));
                  });
              };
              throw new Error("Failed pattern match at ViewComponent line 416, column 3 - line 421, column 31: " + [ v1.constructor.name ]);
          });
      };
      throw new Error("Failed pattern match at ViewComponent line 280, column 1 - line 280, column 54: " + [ v.constructor.name ]);
  };
  var component = (function () {
      ...
      return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)(spec$prime);
  })();
  exports["interval"] = interval;
  exports["StartToken"] = StartToken;
  exports["RegularToken"] = RegularToken;
  exports["removeEscapeChar"] = removeEscapeChar;
  exports["addOnKeyDownEventListener"] = addOnKeyDownEventListener;
  ...
  exports["repGenericSession"] = repGenericSession;
