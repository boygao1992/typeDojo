...
(function(exports) {
  ...
  var addOnKeyDownEventListener = function (document) {
      return function (fn) {
          ...
          return function __do() {
              var v = Web_Event_EventTarget.eventListener(function ($130) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(fn)(Web_UIEvent_KeyboardEvent.fromEvent($130));
              })();
  ...
  var $$eval = function (v) {
      if (v instanceof Init) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_Window.document(v1)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addOnKeyDownEventListener(v2))(function ($131) {
                      return Data_Maybe.Just.create(Halogen_Query.request(OnKeyDown.create($131)));
                  })))(function () {
      ...
      if (v instanceof OnKeyDown) {
          var startTimer = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v1) {
              return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addTimer(v1))(function ($132) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isEnter(key) && (Data_Eq.eq(eqStatus)(v2.status)(Playing.value) && Data_String_CodePoints.length(v2.input) === Data_String_CodePoints.length(v2.dojo)))((function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $89.initTime = new Data_Maybe.Just(v1);
                                  $89.currentTime = new Data_Maybe.Just(v1);
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isPrint(key))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_String_CodePoints.length(v2.input) < Data_String_CodePoints.length(v2.dojo))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  if (v2.status instanceof Stopped) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          ...
                                          $96.initTime = new Data_Maybe.Just(v1);
                                          $96.currentTime = new Data_Maybe.Just(v1);
                                  ...
                                  if (v2.status instanceof Paused) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          ...
                                          $99.initTime = new Data_Maybe.Just(v1);
                                          $99.currentTime = new Data_Maybe.Just(v1);
                                          return $99;
                                      }))(function () {
                                          return startTimer;
                                      });
                                  ...
                                  throw new Error("Failed pattern match at ViewComponent line 296, column 5 - line 314, column 27: " + [ v2.status.constructor.name ]);
                              })))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isBackspace(key))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $102.input = Data_String_CodeUnits.dropRight(1)(v2.input);
                                      return $102;
                                  })))(function () {
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isSpace(key))((function () {
                                                  if (v2.status instanceof Stopped) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                          ...
                                                          $112.status = Playing.value;
                                                          $112.initTime = new Data_Maybe.Just(v1);
                                                          $112.currentTime = new Data_Maybe.Just(v1);
                                                          $112.duration = Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds);
                                                          return $112;
                                                      }))(function () {
                                                          return startTimer;
                                                      });
                                                  ...
                                                  if (v2.status instanceof Paused) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                          ...
                                                          $115.status = Playing.value;
                                                          $115.initTime = new Data_Maybe.Just(v1);
                                                          $115.currentTime = new Data_Maybe.Just(v1);
                                                          return $115;
                                                      }))(function () {
                                                          return startTimer;
                                                      });
                                                  ...
                                                  if (v2.status instanceof Playing) {
                                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                          ...
                                                          $118.status = Paused.value;
                                                          $118.initTime = new Data_Maybe.Just(v1);
                                                          $118.currentTime = new Data_Maybe.Just(v1);
                                                          $118.duration = Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v2.duration)(interval(v2.initTime)(new Data_Maybe.Just(v1)));
                                                          return $118;
                                                      });
                                                  };
                                                  throw new Error("Failed pattern match at ViewComponent line 326, column 5 - line 351, column 15: " + [ v2.status.constructor.name ]);
                                              })()))(function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              if (v1 instanceof Playing) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $125.currentTime = new Data_Maybe.Just(v.value0);
                      return $125;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Halogen_Query_EventSource.Listening.value));
                  });
              };
              throw new Error("Failed pattern match at ViewComponent line 366, column 3 - line 371, column 31: " + [ v1.constructor.name ]);
          });
      };
      throw new Error("Failed pattern match at ViewComponent line 231, column 1 - line 231, column 54: " + [ v.constructor.name ]);
  };
