...
(function(exports) {
  ...
  var showStatus = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at ViewComponent line 128, column 1 - line 128, column 35: " + [ v.constructor.name ]);
  });
  ...
  var isPrint = function (str) {
      ...
      throw new Error("Failed pattern match at ViewComponent line 61, column 1 - line 61, column 29: " + [ str.constructor.name ]);
  };
  var isLeft = function (v) {
      return v === "ArrowLeft";
  };
  ...
  var initialState = {
      ...
      initTime: Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds),
      currentTime: Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds),
  ...
  var eqKeyMatch = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof KeyCorrect && y instanceof KeyCorrect) {
              return true;
          };
          if (x instanceof KeyWrong && y instanceof KeyWrong) {
              return true;
          };
          if (x instanceof KeyNoInput && y instanceof KeyNoInput) {
              return true;
          };
          return false;
      };
  ...
  var charBlock = function (isCursor) {
      return function (v) {
          return Halogen_HTML_Elements.span([ HalogenUtils.classList_([ new Data_Tuple.Tuple(true, ClassNames.charblock), new Data_Tuple.Tuple(Data_Eq.eq(eqKeyMatch)(v.status)(KeyCorrect.value), ClassNames.keyCorrect), new Data_Tuple.Tuple(Data_Eq.eq(eqKeyMatch)(v.status)(KeyWrong.value), ClassNames.keyWrong), new Data_Tuple.Tuple(isCursor, ClassNames.cursor) ]) ])([ Halogen_HTML_Core.text(ShowChar.showChar(v.key)) ]);
      };
  };
  ...
  var render = function (v) {
      ...
      var processed = (function (v1) {
          ...
          return {
              key: v1.value1,
              status: KeyWrong.value
          };
      })(Data_Array.zip(_input)(_dojo)));
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(viewTimer(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v.duration)(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v.currentTime)(Data_Time_Duration.negateDuration(Data_Time_Duration.durationMilliseconds)(v.initTime))))) ]), Halogen_HTML_Elements.p_(Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (idx) {
          return function (acc) {
  ...
  var addTimer = function (window) {
      return function (fn) {
          return function __do() {
              var v = Effect_Timer.setInterval(50)(Data_Functor["void"](Effect.functorEffect)(Web_HTML_Window.requestAnimationFrame(Control_Bind.bindFlipped(Effect.bindEffect)(fn)(Data_Functor.map(Effect.functorEffect)(Data_DateTime_Instant.unInstant)(Effect_Now.now)))(window)))();
  ...
  var addOnKeyDownEventListener = function (document) {
      return function (fn) {
          ...
          return function __do() {
              var v = Web_Event_EventTarget.eventListener(function ($140) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(fn)(Web_UIEvent_KeyboardEvent.fromEvent($140));
              })();
      ...
      if (v instanceof Init) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_Window.document(v1)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addOnKeyDownEventListener(v2))(function ($141) {
                      return Data_Maybe.Just.create(Halogen_Query.request(OnKeyDown.create($141)));
                  })))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.get(Affjax_ResponseFormat.string)("/dojo")))(function (v3) {
                          var dojo = Data_String_CodeUnits.dropRight(1)(Data_String_CodeUnits.drop(1)(Data_Either.either(Data_Function["const"](""))(Control_Category.identity(Control_Category.categoryFn))(v3.body)));
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $89.history = Data_Array.snoc(v2.history)({
                              key: Web_UIEvent_KeyboardEvent.key(v.value0),
                              timeStamp: v1
                          });
                          return $89;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isEnter(key) && (Data_Eq.eq(eqStatus)(v2.status)(Playing.value) && Data_String_CodePoints.length(v2.input) === Data_String_CodePoints.length(v2.dojo)))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $92 = {};
                              for (var $93 in v3) {
                              ...
                              $92.status = Stopped.value;
                              $92.initTime = v1;
                              $92.currentTime = v1;
                              $92.duration = Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v2.duration)(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v1)(Data_Time_Duration.negateDuration(Data_Time_Duration.durationMilliseconds)(v2.initTime)));
                              return $92;
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.put(Affjax_ResponseFormat.string)("/dojo/record" + ("?duration=" + Data_Show.show(Data_Time_Duration.showMilliseconds)(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v2.duration)(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v1)(Data_Time_Duration.negateDuration(Data_Time_Duration.durationMilliseconds)(v2.initTime))))))(Affjax_RequestBody.string(Foreign_Generic.genericEncodeJSON(repGenericSession)(Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
                                  return "Session";
                                  ...
                                  input: v2.input,
                                  dojo: v2.dojo,
                                  duration: Data_Newtype.unwrap(Data_Time_Duration.newtypeMilliseconds)(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v2.duration)(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v1)(Data_Time_Duration.negateDuration(Data_Time_Duration.durationMilliseconds)(v2.initTime))))
                              }))))))(function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isPrint(key))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_String_CodePoints.length(v2.input) < Data_String_CodePoints.length(v2.dojo))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  if (v2.status instanceof Stopped) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          var $99 = {};
                                          for (var $100 in v3) {
                                              if ({}.hasOwnProperty.call(v3, $100)) {
                                                  $99[$100] = v3[$100];
                                              };
                                          };
                                          $99.status = Playing.value;
                                          $99.initTime = v1;
                                          $99.currentTime = v1;
                                          $99.duration = Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds);
                                          return $99;
                                      }))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v3) {
                                              return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addTimer(v3))(function ($142) {
                                                  return Data_Maybe.Just.create(Halogen_Query.request(Tick.create($142)));
                                              }));
                                          });
                                      });
                                  };
                                  if (v2.status instanceof Paused) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          ...
                                          $103.status = Playing.value;
                                          $103.initTime = v1;
                                          $103.currentTime = v1;
                                          return $103;
                                      }))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v3) {
                                              return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addTimer(v3))(function ($143) {
                                                  return Data_Maybe.Just.create(Halogen_Query.request(Tick.create($143)));
                                              }));
                                          });
                                      });
                                  };
                                  throw new Error("Failed pattern match at ViewComponent line 276, column 5 - line 294, column 87: " + [ v2.status.constructor.name ]);
                              })))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isBackspace(key))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                      ...
                                      $107.input = Data_String_CodeUnits.dropRight(1)(v2.input);
                                      return $107;
                                  })))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isLeft(key))(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v2.cursor > 0)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                          var $110 = {};
                                          for (var $111 in v3) {
                                          ...
                                          $110.cursor = v2.cursor - 1 | 0;
                                          return $110;
                                      }))))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isRight(key))(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v2.cursor < (Data_String_CodePoints.length(v2.dojo) - 1 | 0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                              var $113 = {};
                                              for (var $114 in v3) {
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isSpace(key))((function () {
                                                  if (v2.status instanceof Stopped) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                          ...
                                                          $117.status = Playing.value;
                                                          $117.initTime = v1;
                                                          $117.currentTime = v1;
                                                          $117.duration = Data_Monoid.mempty(Data_Time_Duration.monoidMilliseconds);
                                                          return $117;
                                                      }))(function () {
                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v3) {
                                                              return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addTimer(v3))(function ($144) {
                                                                  return Data_Maybe.Just.create(Halogen_Query.request(Tick.create($144)));
                                                              }));
                                                          });
                                                      });
                                                  };
                                                  if (v2.status instanceof Paused) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                          ...
                                                          $121.status = Playing.value;
                                                          $121.initTime = v1;
                                                          $121.currentTime = v1;
                                                          return $121;
                                                      }))(function () {
                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v3) {
                                                              return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addTimer(v3))(function ($145) {
                                                                  return Data_Maybe.Just.create(Halogen_Query.request(Tick.create($145)));
                                                              }));
                                                          });
                                                      });
                                                  };
                                                  if (v2.status instanceof Playing) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                          ...
                                                          $125.status = Paused.value;
                                                          $125.initTime = v1;
                                                          $125.currentTime = v1;
                                                          $125.duration = Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(st.duration)(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v1)(Data_Time_Duration.negateDuration(Data_Time_Duration.durationMilliseconds)(st.initTime)));
                                                          return $125;
                                                      }))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                              var $128 = {};
                                                              for (var $129 in v3) {
                                                                  if ({}.hasOwnProperty.call(v3, $129)) {
                                                                      $128[$129] = v3[$129];
                                                                  };
                                                              };
                                                              $128.status = Paused.value;
                                                              return $128;
                                                          }))(function () {
                                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                                          });
                                                  ...
                                                  throw new Error("Failed pattern match at ViewComponent line 308, column 5 - line 329, column 18: " + [ v2.status.constructor.name ]);
                                              })()))(function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              if (v1 instanceof Playing) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $135.currentTime = v.value0;
                      return $135;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Halogen_Query_EventSource.Listening.value));
                  });
              };
              throw new Error("Failed pattern match at ViewComponent line 339, column 3 - line 344, column 31: " + [ v1.constructor.name ]);
          });
      };
      throw new Error("Failed pattern match at ViewComponent line 227, column 1 - line 227, column 54: " + [ v.constructor.name ]);
  };
