...
(function(exports) {
  ...
  var persistDojoSession = function (session) {
      return function __do() {
          ...
          return Node_FS_Sync.writeTextFile(Node_Encoding.UTF8.value)("./record/" + v)(session)();
      };
  };
...
(function(exports) {
  ...
  var createRecordHandler = Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Node_Express_Request.getQueryParam("duration"))(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_Handler.bindHandlerM)((function () {
          if (v instanceof Data_Maybe.Nothing) {
              return respondError("Duration is required.");
          };
          if (v instanceof Data_Maybe.Just) {
              return Effect_Class.liftEffect(Node_Express_Handler.monadEffHandlerM)(Effects.persistDojoSession(v.value0));
          };
          throw new Error("Failed pattern match at Main line 41, column 3 - line 45, column 47: " + [ v.constructor.name ]);
      })())(function () {
          return Node_Express_Response.sendJson({
              status: "Recorded"
          });
  ...
  var main = function __do() {
      ...
      var port = (function () {
          ...
          throw new Error("Failed pattern match at Main line 60, column 14 - line 63, column 54: " + [ v.constructor.name ]);
      })();
