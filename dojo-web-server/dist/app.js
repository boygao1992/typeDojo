...
(function(exports) {
  ...
  var genRandomChars = function (n) {
      ...
      throw new Error("Failed pattern match at Effects line 23, column 1 - line 23, column 45: " + [ n.constructor.name ]);
  };
  var genRandomString = function ($9) {
      return Data_Functor.map(Effect.functorEffect)(Data_String_CodeUnits.fromCharArray)(genRandomChars($9));
  };
...
(function(exports) {
  ...
  var getDojoHandler = Control_Bind.bind(Node_Express_Handler.bindHandlerM)(Effect_Class.liftEffect(Node_Express_Handler.monadEffHandlerM)(Effects.genRandomString(500)))(function (v) {
  ...
  var appSetup = Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Effect_Class.liftEffect(Node_Express_App.monadEffectAppM)(Effect_Console.log("Setting up")))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.useExternal(JSMiddleware.jsonBodyParser))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.use(indexHandler))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Node_Express_App.bindAppM)(Node_Express_App.get(Node_Express_Types.routePath)("/dojo")(getDojoHandler))(function () {
  ...
  var main = function __do() {
      ...
      var port = (function () {
          ...
          throw new Error("Failed pattern match at Main line 56, column 14 - line 59, column 54: " + [ v.constructor.name ]);
      })();
