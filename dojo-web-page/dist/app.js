...
(function(exports) {
  ...
  var root = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector.star)(CSS_Box.boxSizing(CSS_Box.borderBox)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.body)(CSSUtils.pair("font-family")("Consolas, monospace")))(function () {
          return CSS_Stylesheet.select(Selectors.charblock)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.inlineBlock))(function () {
              return CSS_Background.backgroundColor(Colors.robinsEggBlue);
          }));
      });
  });
  exports["root"] = root;
...
(function(exports) {
  ...
  var classList = function ($2) {
      return Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)($2));
  };
...
(function(exports) {
  ...
  var isPrint = function (str) {
      ...
      throw new Error("Failed pattern match at ViewComponent line 42, column 1 - line 42, column 29: " + [ str.constructor.name ]);
  };
  ...
  var charBlock = function ($$char) {
      return Halogen_HTML_Elements.span([ HalogenUtils.classList([ ClassNames.charblock ]) ])([ Halogen_HTML_Core.text(ShowChar.showChar($$char)) ]);
  };
  var render = function (v) {
      ...
      })([  ])(Data_String_CodeUnits.toCharArray(v.input))), Halogen_HTML_CSS.stylesheet(CSS_Root.root) ]);
  };
  var addOnKeyDownEventListener = function (document) {
      return function (fn) {
          var target = Web_HTML_HTMLDocument.toEventTarget(document);
          return function __do() {
              var v = Web_Event_EventTarget.eventListener(function ($30) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(fn)(Web_UIEvent_KeyboardEvent.fromEvent($30));
              })();
  ...
  var $$eval = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $17.history = Data_Array.snoc(v2.history)({
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isPrint(key))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isBackspace(key))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $23 = {};
                                  for (var $24 in v3) {
                                      if ({}.hasOwnProperty.call(v3, $24)) {
                                          $23[$24] = v3[$24];
                                      };
                                  };
                                  $23.input = Data_String_CodeUnits.dropRight(1)(v2.input);
                                  return $23;
                              })))(function () {
      ...
      if (v instanceof Init) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addOnKeyDownEventListener(v1))(function ($31) {
                  return Data_Maybe.Just.create(Halogen_Query.request(OnKeyDown.create($31)));
              })))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          }));
      };
      throw new Error("Failed pattern match at ViewComponent line 98, column 1 - line 98, column 54: " + [ v.constructor.name ]);
  };
