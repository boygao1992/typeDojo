...
(function(exports) {
  ...
  var showStatus = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at ViewComponent line 113, column 1 - line 113, column 35: " + [ v.constructor.name ]);
  });
  ...
  var isPrint = function (str) {
      ...
      throw new Error("Failed pattern match at ViewComponent line 57, column 1 - line 57, column 29: " + [ str.constructor.name ]);
  };
  var isLeft = function (v) {
      return v === "ArrowLeft";
  };
  ...
  var render = function (v) {
      ...
      })([  ])(processed)), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("input: " + Data_Show.show(Data_Show.showString)(v.input)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("cursor: " + Data_Show.show(Data_Show.showInt)(v.cursor)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("status: " + Data_Show.show(showStatus)(v.status)) ]), Halogen_HTML_CSS.stylesheet(CSS_Root.root) ]);
  };
  ...
  var addOnKeyDownEventListener = function (document) {
      return function (fn) {
          ...
          return function __do() {
              var v = Web_Event_EventTarget.eventListener(function ($114) {
                  return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(fn)(Web_UIEvent_KeyboardEvent.fromEvent($114));
              })();
      ...
      if (v instanceof Init) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML_Window.document(v1)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addOnKeyDownEventListener(v2))(function ($115) {
                      return Data_Maybe.Just.create(Halogen_Query.request(OnKeyDown.create($115)));
                  })))(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $75.history = Data_Array.snoc(v2.history)({
                              key: Web_UIEvent_KeyboardEvent.key(v.value0),
                              timeStamp: v1
                          });
                          return $75;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isPrint(key))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $78 = {};
                              for (var $79 in v3) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isBackspace(key))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $81.input = Data_String_CodeUnits.dropRight(1)(v2.input);
                                  return $81;
                              })))(function () {
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(isSpace(key))((function () {
                                              if (v2.status instanceof Stopped) {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                      ...
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v3) {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addTimer(v3))(function ($116) {
                                                              return Data_Maybe.Just.create(Halogen_Query.request(Tick.create($116)));
                                                          })))(function () {
                                              ...
                                              if (v2.status instanceof Paused) {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                      ...
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_HTML.window))(function (v3) {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource["eventSource'"](Effect_Aff_Class.monadAffAff)(addTimer(v3))(function ($117) {
                                                              return Data_Maybe.Just.create(Halogen_Query.request(Tick.create($117)));
                                                          })))(function () {
                                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                                          });
                                                      });
                                              ...
                                              if (v2.status instanceof Playing) {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                      var $99 = {};
                                                      for (var $100 in st) {
                                                          if ({}.hasOwnProperty.call(st, $100)) {
                                                              $99[$100] = st[$100];
                                                          };
                                                      };
                                                      $99.status = Paused.value;
                                                      $99.initTime = v1;
                                                      $99.currentTime = v1;
                                                      $99.duration = Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(st.duration)(Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(v1)(Data_Time_Duration.negateDuration(Data_Time_Duration.durationMilliseconds)(st.initTime)));
                                                      return $99;
                                                  }))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                          var $102 = {};
                                              ...
                                              throw new Error("Failed pattern match at ViewComponent line 247, column 5 - line 270, column 18: " + [ v2.status.constructor.name ]);
                                          })()))(function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              if (v1 instanceof Playing) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $109.currentTime = v.value0;
                      return $109;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Halogen_Query_EventSource.Listening.value));
                  });
              };
              throw new Error("Failed pattern match at ViewComponent line 275, column 3 - line 280, column 31: " + [ v1.constructor.name ]);
          });
      };
      throw new Error("Failed pattern match at ViewComponent line 208, column 1 - line 208, column 54: " + [ v.constructor.name ]);
  };
