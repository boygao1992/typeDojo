...
(function(exports) {
  ...
  var OnInput = (function () {
      function OnInput(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OnInput.create = function (value0) {
          return function (value1) {
              return new OnInput(value0, value1);
          };
      };
      return OnInput;
  })();
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(OnKeyDown.create)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(OnInput.create)), Halogen_HTML_Properties.value(state.input) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "history";
          ...
          return "timeStamp";
      }))(Data_Show.showRecordFieldsNil)(Data_Time_Duration.showMilliseconds))(Data_Show.showString))))))(state)) ]) ]);
  };
  var initialState = {
      history: [  ],
      input: ""
  ...
  var $$eval = function (v) {
          ...
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_DateTime_Instant.unInstant)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Now.now)))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      var $9 = {};
                      for (var $10 in v3) {
                          if ({}.hasOwnProperty.call(v3, $10)) {
                              $9[$10] = v3[$10];
                          };
                      };
                      $9.history = Data_Array.snoc(v2)({
      ...
      throw new Error("Failed pattern match at ViewComponent line 65, column 1 - line 65, column 54: " + [ v.constructor.name ]);
  };
